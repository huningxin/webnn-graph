...
export async function buildGraph(context, weights) {
  ...
  const past_sequence_length = {name: 'past_sequence_length', maxSize: 2048};
  ...
  }
  {
    ...
    // See WebNN EP gqa_op_builder.cc for details: https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/core/providers/webnn/builders/impl/gqa_op_builder.cc#L209
    // Change it to input for setting prefill and decoding modes.
    env.set("_601", builder.input("webnn_GQA_condition_constant_for_where_1", {dataType: "uint8", shape: [1] }));
  }
  {
  ...
  }
  {
    ...
    // See WebNN EP gqa_op_builder.cc for details: https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/core/providers/webnn/builders/impl/gqa_op_builder.cc#L200
    // Change it to input to allow dynamic sequence length.
    env.set("_604", builder.input("webnn_GQA_right_constant_of_scatter_indices", {dataType: "int32", shape: [sequence_length, 4, 1] }));
  }
  {
    ...
    // See WebNN EP gqa_op_builder.cc for details: https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/core/providers/webnn/builders/impl/gqa_op_builder.cc#L194
    // Change it to input to allow dynamic sequence length.
    env.set("_606", builder.input("webnn_GQA_left_constant_of_scatter_indices", {dataType: "int32", shape: [sequence_length, 4, 2] }));
  }
  {
    ...
    // See WebNN EP gqa_op_builder.cc for details: https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/core/providers/webnn/builders/impl/gqa_op_builder.cc#L319
    // Change it to input to allow dynamic sequence length.
    env.set("_613", builder.input("webnn_GQA_pre_neq_right_data_range", {dataType: "int32", shape: [past_sequence_length, sequence_length] }));
  }
  {
    ...
    // See WebNN EP gqa_op_builder.cc for details: https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/core/providers/webnn/builders/impl/gqa_op_builder.cc#L299
    ...
    env.set("_617", builder.input("value_int_one_constant", {dataType: "int32", shape: [1, 32, sequence_length, past_sequence_length] }));
  }
  {
  ...
  env.set("_607", builder.concat([env.get("_606"), env.get("_605")], 2, {"label":"/model/layers.0/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_286"}));
  ...
  env.set("_611", builder.expand(env.get("_610"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.0/attn/GroupQueryAttention_/GQA/true_present_value/expand_293"}));
  ...
  env.set("_654", builder.expand(env.get("_653"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.0/attn/GroupQueryAttention_/GQA/true_present_key/expand_331"}));
  ...
  env.set("_618", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.0/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_298"}));
  ...
  env.set("_615", builder.expand(env.get("_614"), [past_sequence_length,sequence_length], {"label":"/model/layers.0/attn/GroupQueryAttention_/GQA/expand_neq_right_296"}));
  ...
  env.set("_733", builder.concat([env.get("_606"), env.get("_732")], 2, {"label":"/model/layers.1/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_402"}));
  ...
  env.set("_737", builder.expand(env.get("_736"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.1/attn/GroupQueryAttention_/GQA/true_present_value/expand_409"}));
  ...
  env.set("_773", builder.expand(env.get("_772"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.1/attn/GroupQueryAttention_/GQA/true_present_key/expand_447"}));
  ...
  env.set("_742", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.1/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_414"}));
  ...
  env.set("_740", builder.expand(env.get("_739"), [past_sequence_length,sequence_length], {"label":"/model/layers.1/attn/GroupQueryAttention_/GQA/expand_neq_right_412"}));
  ...
  env.set("_852", builder.concat([env.get("_606"), env.get("_851")], 2, {"label":"/model/layers.2/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_519"}));
  ...
  env.set("_856", builder.expand(env.get("_855"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.2/attn/GroupQueryAttention_/GQA/true_present_value/expand_526"}));
  ...
  env.set("_892", builder.expand(env.get("_891"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.2/attn/GroupQueryAttention_/GQA/true_present_key/expand_564"}));
  ...
  env.set("_861", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.2/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_531"}));
  ...
  env.set("_859", builder.expand(env.get("_858"), [past_sequence_length,sequence_length], {"label":"/model/layers.2/attn/GroupQueryAttention_/GQA/expand_neq_right_529"}));
  ...
  env.set("_971", builder.concat([env.get("_606"), env.get("_970")], 2, {"label":"/model/layers.3/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_636"}));
  ...
  env.set("_975", builder.expand(env.get("_974"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.3/attn/GroupQueryAttention_/GQA/true_present_value/expand_643"}));
  ...
  env.set("_1011", builder.expand(env.get("_1010"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.3/attn/GroupQueryAttention_/GQA/true_present_key/expand_681"}));
  ...
  env.set("_980", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.3/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_648"}));
  ...
  env.set("_978", builder.expand(env.get("_977"), [past_sequence_length,sequence_length], {"label":"/model/layers.3/attn/GroupQueryAttention_/GQA/expand_neq_right_646"}));
  ...
  env.set("_1090", builder.concat([env.get("_606"), env.get("_1089")], 2, {"label":"/model/layers.4/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_753"}));
  ...
  env.set("_1094", builder.expand(env.get("_1093"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.4/attn/GroupQueryAttention_/GQA/true_present_value/expand_760"}));
  ...
  env.set("_1130", builder.expand(env.get("_1129"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.4/attn/GroupQueryAttention_/GQA/true_present_key/expand_798"}));
  ...
  env.set("_1099", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.4/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_765"}));
  ...
  env.set("_1097", builder.expand(env.get("_1096"), [past_sequence_length,sequence_length], {"label":"/model/layers.4/attn/GroupQueryAttention_/GQA/expand_neq_right_763"}));
  ...
  env.set("_1209", builder.concat([env.get("_606"), env.get("_1208")], 2, {"label":"/model/layers.5/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_870"}));
  ...
  env.set("_1213", builder.expand(env.get("_1212"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.5/attn/GroupQueryAttention_/GQA/true_present_value/expand_877"}));
  ...
  env.set("_1249", builder.expand(env.get("_1248"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.5/attn/GroupQueryAttention_/GQA/true_present_key/expand_915"}));
  ...
  env.set("_1218", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.5/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_882"}));
  ...
  env.set("_1216", builder.expand(env.get("_1215"), [past_sequence_length,sequence_length], {"label":"/model/layers.5/attn/GroupQueryAttention_/GQA/expand_neq_right_880"}));
  ...
  env.set("_1328", builder.concat([env.get("_606"), env.get("_1327")], 2, {"label":"/model/layers.6/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_987"}));
  ...
  env.set("_1332", builder.expand(env.get("_1331"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.6/attn/GroupQueryAttention_/GQA/true_present_value/expand_994"}));
  ...
  env.set("_1368", builder.expand(env.get("_1367"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.6/attn/GroupQueryAttention_/GQA/true_present_key/expand_1032"}));
  ...
  env.set("_1337", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.6/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_999"}));
  ...
  env.set("_1335", builder.expand(env.get("_1334"), [past_sequence_length,sequence_length], {"label":"/model/layers.6/attn/GroupQueryAttention_/GQA/expand_neq_right_997"}));
  ...
  env.set("_1447", builder.concat([env.get("_606"), env.get("_1446")], 2, {"label":"/model/layers.7/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1104"}));
  ...
  env.set("_1451", builder.expand(env.get("_1450"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.7/attn/GroupQueryAttention_/GQA/true_present_value/expand_1111"}));
  ...
  env.set("_1487", builder.expand(env.get("_1486"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.7/attn/GroupQueryAttention_/GQA/true_present_key/expand_1149"}));
  ...
  env.set("_1456", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.7/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1116"}));
  ...
  env.set("_1454", builder.expand(env.get("_1453"), [past_sequence_length,sequence_length], {"label":"/model/layers.7/attn/GroupQueryAttention_/GQA/expand_neq_right_1114"}));
  ...
  env.set("_1566", builder.concat([env.get("_606"), env.get("_1565")], 2, {"label":"/model/layers.8/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1221"}));
  ...
  env.set("_1570", builder.expand(env.get("_1569"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.8/attn/GroupQueryAttention_/GQA/true_present_value/expand_1228"}));
  ...
  env.set("_1606", builder.expand(env.get("_1605"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.8/attn/GroupQueryAttention_/GQA/true_present_key/expand_1266"}));
  ...
  env.set("_1575", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.8/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1233"}));
  ...
  env.set("_1573", builder.expand(env.get("_1572"), [past_sequence_length,sequence_length], {"label":"/model/layers.8/attn/GroupQueryAttention_/GQA/expand_neq_right_1231"}));
  ...
  env.set("_1685", builder.concat([env.get("_606"), env.get("_1684")], 2, {"label":"/model/layers.9/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1338"}));
  ...
  env.set("_1689", builder.expand(env.get("_1688"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.9/attn/GroupQueryAttention_/GQA/true_present_value/expand_1345"}));
  ...
  env.set("_1725", builder.expand(env.get("_1724"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.9/attn/GroupQueryAttention_/GQA/true_present_key/expand_1383"}));
  ...
  env.set("_1694", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.9/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1350"}));
  ...
  env.set("_1692", builder.expand(env.get("_1691"), [past_sequence_length,sequence_length], {"label":"/model/layers.9/attn/GroupQueryAttention_/GQA/expand_neq_right_1348"}));
  ...
  env.set("_1804", builder.concat([env.get("_606"), env.get("_1803")], 2, {"label":"/model/layers.10/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1455"}));
  ...
  env.set("_1808", builder.expand(env.get("_1807"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.10/attn/GroupQueryAttention_/GQA/true_present_value/expand_1462"}));
  ...
  env.set("_1844", builder.expand(env.get("_1843"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.10/attn/GroupQueryAttention_/GQA/true_present_key/expand_1500"}));
  ...
  env.set("_1813", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.10/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1467"}));
  ...
  env.set("_1811", builder.expand(env.get("_1810"), [past_sequence_length,sequence_length], {"label":"/model/layers.10/attn/GroupQueryAttention_/GQA/expand_neq_right_1465"}));
  ...
  env.set("_1923", builder.concat([env.get("_606"), env.get("_1922")], 2, {"label":"/model/layers.11/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1572"}));
  ...
  env.set("_1927", builder.expand(env.get("_1926"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.11/attn/GroupQueryAttention_/GQA/true_present_value/expand_1579"}));
  ...
  env.set("_1963", builder.expand(env.get("_1962"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.11/attn/GroupQueryAttention_/GQA/true_present_key/expand_1617"}));
  ...
  env.set("_1932", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.11/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1584"}));
  ...
  env.set("_1930", builder.expand(env.get("_1929"), [past_sequence_length,sequence_length], {"label":"/model/layers.11/attn/GroupQueryAttention_/GQA/expand_neq_right_1582"}));
  ...
  env.set("_2042", builder.concat([env.get("_606"), env.get("_2041")], 2, {"label":"/model/layers.12/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1689"}));
  ...
  env.set("_2046", builder.expand(env.get("_2045"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.12/attn/GroupQueryAttention_/GQA/true_present_value/expand_1696"}));
  ...
  env.set("_2082", builder.expand(env.get("_2081"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.12/attn/GroupQueryAttention_/GQA/true_present_key/expand_1734"}));
  ...
  env.set("_2051", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.12/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1701"}));
  ...
  env.set("_2049", builder.expand(env.get("_2048"), [past_sequence_length,sequence_length], {"label":"/model/layers.12/attn/GroupQueryAttention_/GQA/expand_neq_right_1699"}));
  ...
  env.set("_2161", builder.concat([env.get("_606"), env.get("_2160")], 2, {"label":"/model/layers.13/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1806"}));
  ...
  env.set("_2165", builder.expand(env.get("_2164"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.13/attn/GroupQueryAttention_/GQA/true_present_value/expand_1813"}));
  ...
  env.set("_2201", builder.expand(env.get("_2200"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.13/attn/GroupQueryAttention_/GQA/true_present_key/expand_1851"}));
  ...
  env.set("_2170", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.13/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1818"}));
  ...
  env.set("_2168", builder.expand(env.get("_2167"), [past_sequence_length,sequence_length], {"label":"/model/layers.13/attn/GroupQueryAttention_/GQA/expand_neq_right_1816"}));
  ...
  env.set("_2280", builder.concat([env.get("_606"), env.get("_2279")], 2, {"label":"/model/layers.14/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_1923"}));
  ...
  env.set("_2284", builder.expand(env.get("_2283"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.14/attn/GroupQueryAttention_/GQA/true_present_value/expand_1930"}));
  ...
  env.set("_2320", builder.expand(env.get("_2319"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.14/attn/GroupQueryAttention_/GQA/true_present_key/expand_1968"}));
  ...
  env.set("_2289", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.14/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_1935"}));
  ...
  env.set("_2287", builder.expand(env.get("_2286"), [past_sequence_length,sequence_length], {"label":"/model/layers.14/attn/GroupQueryAttention_/GQA/expand_neq_right_1933"}));
  ...
  env.set("_2399", builder.concat([env.get("_606"), env.get("_2398")], 2, {"label":"/model/layers.15/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2040"}));
  ...
  env.set("_2403", builder.expand(env.get("_2402"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.15/attn/GroupQueryAttention_/GQA/true_present_value/expand_2047"}));
  ...
  env.set("_2439", builder.expand(env.get("_2438"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.15/attn/GroupQueryAttention_/GQA/true_present_key/expand_2085"}));
  ...
  env.set("_2408", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.15/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2052"}));
  ...
  env.set("_2406", builder.expand(env.get("_2405"), [past_sequence_length,sequence_length], {"label":"/model/layers.15/attn/GroupQueryAttention_/GQA/expand_neq_right_2050"}));
  ...
  env.set("_2518", builder.concat([env.get("_606"), env.get("_2517")], 2, {"label":"/model/layers.16/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2157"}));
  ...
  env.set("_2522", builder.expand(env.get("_2521"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.16/attn/GroupQueryAttention_/GQA/true_present_value/expand_2164"}));
  ...
  env.set("_2558", builder.expand(env.get("_2557"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.16/attn/GroupQueryAttention_/GQA/true_present_key/expand_2202"}));
  ...
  env.set("_2527", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.16/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2169"}));
  ...
  env.set("_2525", builder.expand(env.get("_2524"), [past_sequence_length,sequence_length], {"label":"/model/layers.16/attn/GroupQueryAttention_/GQA/expand_neq_right_2167"}));
  ...
  env.set("_2637", builder.concat([env.get("_606"), env.get("_2636")], 2, {"label":"/model/layers.17/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2274"}));
  ...
  env.set("_2641", builder.expand(env.get("_2640"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.17/attn/GroupQueryAttention_/GQA/true_present_value/expand_2281"}));
  ...
  env.set("_2677", builder.expand(env.get("_2676"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.17/attn/GroupQueryAttention_/GQA/true_present_key/expand_2319"}));
  ...
  env.set("_2646", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.17/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2286"}));
  ...
  env.set("_2644", builder.expand(env.get("_2643"), [past_sequence_length,sequence_length], {"label":"/model/layers.17/attn/GroupQueryAttention_/GQA/expand_neq_right_2284"}));
  ...
  env.set("_2756", builder.concat([env.get("_606"), env.get("_2755")], 2, {"label":"/model/layers.18/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2391"}));
  ...
  env.set("_2760", builder.expand(env.get("_2759"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.18/attn/GroupQueryAttention_/GQA/true_present_value/expand_2398"}));
  ...
  env.set("_2796", builder.expand(env.get("_2795"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.18/attn/GroupQueryAttention_/GQA/true_present_key/expand_2436"}));
  ...
  env.set("_2765", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.18/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2403"}));
  ...
  env.set("_2763", builder.expand(env.get("_2762"), [past_sequence_length,sequence_length], {"label":"/model/layers.18/attn/GroupQueryAttention_/GQA/expand_neq_right_2401"}));
  ...
  env.set("_2875", builder.concat([env.get("_606"), env.get("_2874")], 2, {"label":"/model/layers.19/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2508"}));
  ...
  env.set("_2879", builder.expand(env.get("_2878"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.19/attn/GroupQueryAttention_/GQA/true_present_value/expand_2515"}));
  ...
  env.set("_2915", builder.expand(env.get("_2914"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.19/attn/GroupQueryAttention_/GQA/true_present_key/expand_2553"}));
  ...
  env.set("_2884", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.19/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2520"}));
  ...
  env.set("_2882", builder.expand(env.get("_2881"), [past_sequence_length,sequence_length], {"label":"/model/layers.19/attn/GroupQueryAttention_/GQA/expand_neq_right_2518"}));
  ...
  env.set("_2994", builder.concat([env.get("_606"), env.get("_2993")], 2, {"label":"/model/layers.20/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2625"}));
  ...
  env.set("_2998", builder.expand(env.get("_2997"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.20/attn/GroupQueryAttention_/GQA/true_present_value/expand_2632"}));
  ...
  env.set("_3034", builder.expand(env.get("_3033"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.20/attn/GroupQueryAttention_/GQA/true_present_key/expand_2670"}));
  ...
  env.set("_3003", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.20/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2637"}));
  ...
  env.set("_3001", builder.expand(env.get("_3000"), [past_sequence_length,sequence_length], {"label":"/model/layers.20/attn/GroupQueryAttention_/GQA/expand_neq_right_2635"}));
  ...
  env.set("_3113", builder.concat([env.get("_606"), env.get("_3112")], 2, {"label":"/model/layers.21/attn/GroupQueryAttention_/GQA/concat_for_pre_scatter_indices_2742"}));
  ...
  env.set("_3117", builder.expand(env.get("_3116"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.21/attn/GroupQueryAttention_/GQA/true_present_value/expand_2749"}));
  ...
  env.set("_3153", builder.expand(env.get("_3152"), [1,4,8,past_sequence_length,64], {"label":"/model/layers.21/attn/GroupQueryAttention_/GQA/true_present_key/expand_2787"}));
  ...
  env.set("_3122", builder.expand(env.get("_617"), [1,32,sequence_length,past_sequence_length], {"label":"/model/layers.21/attn/GroupQueryAttention_/GQA/GQA_mask_shape_ones/expand_2754"}));
  ...
  env.set("_3120", builder.expand(env.get("_3119"), [past_sequence_length,sequence_length], {"label":"/model/layers.21/attn/GroupQueryAttention_/GQA/expand_neq_right_2752"}));
